...
function fixesToReview({ actions, advisories }, highestSeverity) {
  ...
  return `Take the ${chalk.green(actions.length)} actions above to resolve all ${chalk.green(highestSeverity)} severity issues, and run this command again to move to the next severity.`;
}
